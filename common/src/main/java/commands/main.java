        ...
        dispatcher.register(Commands.literal("teleportcommands")
            ...
            .then(Commands.literal("disable")
                .then(Commands.argument("command", StringArgumentType.word())
                    ...
                    .requires(source -> source.permissions().hasPermission(net.minecraft.server.permissions.Permissions.COMMANDS_OWNER)) // Require OP
            ...
            .then(Commands.literal("reload")
                .requires(source -> source.permissions().hasPermission(net.minecraft.server.permissions.Permissions.COMMANDS_OWNER)) // Require OP
                .executes(context -> {
                    tpa.registerCommands(context.getSource().dispatcher());
                    return 0;
                }))
